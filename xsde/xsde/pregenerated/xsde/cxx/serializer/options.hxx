...
#ifndef XSDE_CXX_SERIALIZER_OPTIONS_HXX
#define XSDE_CXX_SERIALIZER_OPTIONS_HXX
...
namespace CXX
{
  namespace Serializer
  {
    class options: public ::CXX::options
    {
      ...
      const bool&
      generate_empty_impl () const;

      bool&
      generate_empty_impl ();

      void
      generate_empty_impl (const bool&);
...
#include <xsde/cxx/serializer/options.ixx>
...
#endif // XSDE_CXX_SERIALIZER_OPTIONS_HXX
