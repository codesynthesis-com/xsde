# Sample configuration file for the Integrity 178b on PPC using the Green
# Hills MULTI C/C++ toolchain. This configuration disables STL, iostream,
# and C++ exceptions.
#

# Toolchain.
#
CC       := /usr/ghs/multi/linux86/cxintppc
CFLAGS   := --no_rtti -I/usr/ghs/int178B/INTEGRITY-include -I/usr/ghs/int178B/ansi -I/usr/ghs/multi/linux86/ansi -I/usr/ghs/multi/linux86/eecxx -I. -c -MD -bsp cds8548 -os_dir /usr/ghs/int178B -G -object_dir=Integrity -DDEBUG -wantprototype
CPPFLAGS :=

CXX      := /usr/ghs/multi/linux86/cxintppc
CXXFLAGS := --no_rtti -I/usr/ghs/int178B/INTEGRITY-include -I/usr/ghs/int178B/ansi -I/usr/ghs/multi/linux86/ansi -I/usr/ghs/multi/linux86/eecxx -I. -c -MD -bsp cds8548 -os_dir /usr/ghs/int178B -G -object_dir=Integrity -DDEBUG -wantprototype
